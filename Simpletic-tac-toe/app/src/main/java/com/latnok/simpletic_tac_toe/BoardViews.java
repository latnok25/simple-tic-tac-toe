...
public class BoardViews extends View {
    ...
    private FiveGridSinglePlayer activity;

    public BoardViews(Context context) {
        super(context);
    }

    public BoardViews(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        gridPaint = new Paint();
    ...
    public void setMainActivity(FiveGridSinglePlayer a) {
        activity = a;
    }

    public void setGameEngine(GameEngines g) {
        gameEngine = g;
    }
